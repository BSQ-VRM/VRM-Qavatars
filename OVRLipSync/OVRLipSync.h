...
#define OVR_LIPSYNC_MINOR_VERSION 45
...
ovrLipSyncResult ovrLipSyncDll_Initialize(int sampleRate, int bufferSize);
...
///
/// \see ovrLipSync_Shutdown
ovrLipSyncResult ovrLipSyncDll_InitializeEx(int sampleRate, int bufferSize, const char* path);
...
///
ovrLipSyncResult ovrLipSyncDll_Shutdown(void);
...
///
const char* ovrLipSyncDll_GetVersion(int* major, int* minor, int* patch);
...
///
ovrLipSyncResult ovrLipSyncDll_CreateContext(
...
/// \see ovrLipSync_DeleteContext
///
ovrLipSyncResult ovrLipSyncDll_CreateContextEx(
    ovrLipSyncContext* pContext,
    const ovrLipSyncContextProvider provider,
    const int sampleRate,
    const bool enableAcceleration);

ovrLipSyncResult ovrLipSyncDll_CreateContextWithModelFile(
...
/// \see ovrLipSync_CreateContext
///
ovrLipSyncResult ovrLipSyncDll_DestroyContext(ovrLipSyncContext context);

/// Reset the internal state of a lip-sync context.
///
/// \param[in] context A valid lip-sync context
///
ovrLipSyncResult ovrLipSyncDll_ResetContext(ovrLipSyncContext context);
...
///
ovrLipSyncResult ovrLipSyncDll_SendSignal(
    ovrLipSyncContext context,
...
///
ovrLipSyncResult ovrLipSyncDll_ProcessFrame(
    ovrLipSyncContext context,
...
/// \param[out] pFrame A pointer to the current viseme frame
///
ovrLipSyncResult ovrLipSyncDll_ProcessFrameInterleaved(
    ovrLipSyncContext context,
    const float* audioBuffer,
    ovrLipSyncFrame* pFrame);
...
/// \param[out] pFrame A pointer to the current viseme frame
///
ovrLipSyncResult ovrLipSyncDll_ProcessFrameEx(
    ovrLipSyncContext context,
...
///
ovrLipSyncResult ovrLipSyncDll_ProcessFrameAsync(
    ovrLipSyncContext context,
    const void* audioBuffer,
    int sampleCount,
    ovrLipSyncAudioDataType dataType,
