...
std::vector<std::string> VRMQavatars::HandController::SplitPose(const std::string& pose)
{
...
std::vector<float> VRMQavatars::HandController::ParseRotations(const std::vector<std::string>& pose)
{
