...
namespace VRMQavatars::FinalIK {
    ...
    public:
        ...
        static void RotateBy(std::vector<VirtualBone*> bones, int index, Sombrero::FastQuaternion rotation);
        static void RotateBy(std::vector<VirtualBone*> bones, Sombrero::FastQuaternion rotation);
        static void RotateTo(std::vector<VirtualBone*> bones, int index, Sombrero::FastQuaternion rotation);
        ...
        static void SolveCCD(std::vector<VirtualBone*> bones, Sombrero::FastVector3 targetPosition, float weight, int iterations);
