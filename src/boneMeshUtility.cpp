...
UnityEngine::Mesh* VRMQavatars::BoneMeshUtility::CreateErasedMesh(UnityEngine::Mesh* src, std::vector<int> eraseBoneIndices)
{
	...
	for (int i = 0; i < src->get_subMeshCount(); i++)
	{
		...
		int num = ExcludeTriangles(indices, src->get_boneWeights(), eraseBoneIndices);
...
int VRMQavatars::BoneMeshUtility::ExcludeTriangles(ArrayW<int>& triangles, ArrayW<UnityEngine::BoneWeight> bws, std::vector<int> exclude)
{
    int num = 0;
    if(bws.size() > 0)
    {
        for (int i = 0; i < triangles.size(); i += 3)
		{
            ...
            UnityEngine::BoneWeight boneWeight = bws[num2];
            ExcludeBoneIndex excludeBoneIndex = AreBoneContains(exclude, boneWeight.m_BoneIndex0, boneWeight.m_BoneIndex1, boneWeight.m_BoneIndex2, boneWeight.m_BoneIndex3);
			...
			{
				UnityEngine::BoneWeight boneWeight2 = bws[num3];
				ExcludeBoneIndex excludeBoneIndex2 = AreBoneContains(exclude, boneWeight2.m_BoneIndex0, boneWeight2.m_BoneIndex1, boneWeight2.m_BoneIndex2, boneWeight2.m_BoneIndex3);
				...
				{
					UnityEngine::BoneWeight boneWeight3 = bws[num4];
					ExcludeBoneIndex excludeBoneIndex3 = AreBoneContains(exclude, boneWeight3.m_BoneIndex0, boneWeight3.m_BoneIndex1, boneWeight3.m_BoneIndex2, boneWeight3.m_BoneIndex3);
...
VRMQavatars::BoneMeshUtility::ExcludeBoneIndex VRMQavatars::BoneMeshUtility::AreBoneContains(std::vector<int>& exclude, int boneIndex0, int boneIndex1, int boneIndex2, int boneIndex3)
{
    bool flag = false;
	bool flag2 = false;
	bool flag3 = false;
	...
	return VRMQavatars::BoneMeshUtility::ExcludeBoneIndex(flag, flag2, flag3, flag4);
}